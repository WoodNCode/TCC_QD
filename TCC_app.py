...
k_ser = st.sidebar.slider("Slip Modulus per connector (N/m)", min_value=100, max_value=2500000000, value=330000000, step=100, format=None, key=None, help="165000000 value for 20 cm TiComTec", on_change=None, args=None, kwargs=None, *, disabled=False, label_visibility="visible")
